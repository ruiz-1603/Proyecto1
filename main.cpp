...
int main() {
   ...
   /* Lista<Materiales>* listaPrestamos = new Lista<Materiales>();
    ...
    listaPrestamos->agregarALista(libro);
    listaPrestamos->agregarALista(revista);
    listaPrestamos->agregarALista(video);


    GestorArchivos<Materiales>::guardarMateriales(listaPrestamos, "Materiales.csv");
